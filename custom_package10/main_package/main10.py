"""
Test 10: Example that does work on Python 2 or 3 run from anywhere
...
import custom_package10.math_package.custom_math10

value = input("Please enter a number to be square rooted: ")
print("{} square rooted = {}".format(value, custom_package10.math_package.custom_math10.sqrt(float(value))))
